...
リストから接続したいBibbleの行をクリックすると、選択したBibbleのボタン操作、距離情報をプログラムCに送出し始める。
（プログラムCは後で起動して良い）
...
ここで、２行以上表示されている場合は、プログラムAにおいて、Bibbleが複数選択されていると考えられるので、Listenをチェックを外して停止、プログラムAを停止して再度操作、Listenを再度チェックとすると良い。
